...
--   - 적용: npx wrangler d1 execute gagyebu --local  --file=migrations/006_token_ver.sql
--          npx wrangler d1 execute gagyebu --remote --file=migrations/006_token_ver.sql   (배포 '전'에)
